...
with open(filepath) as fp:
    for line in fp:
      ...
      jenkinsclicommand = ["java","-jar", "jenkins-cli.jar","-s",localjenkinsurl,"-noCertificateCheck", "-auth", jenkinsUser+":"+userApitoken, "get-job",line]
      ...
      #for logging only
      line=line.replace("Master","Rel3.0")
      ...
      jenkinsclicommand = ["java","-jar", "jenkins-cli.jar","-s",localjenkinsurl, "-noCertificateCheck", "-auth", jenkinsUser+":"+userApitoken, "create-job",line]
      print(jenkinsclicommand)
